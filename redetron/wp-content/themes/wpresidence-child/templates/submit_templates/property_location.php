                ...
                <?php if ($enable_autocomplete_status == 'no'): ?>
                    ...
                    <select id="property_city_submit" name="property_city" class="cd-select">
                        ...
                        foreach ($tax_terms as $tax_term) {
                            ...
                            $city_label = apply_filters('ofiliaria_city_select_label', $tax_term->name, $parent_val);
                            echo '<option value="' . esc_attr($tax_term->name) . '" data-parentcounty="' . esc_attr($parent_val) . '"' . selected($property_city, $tax_term->name, false) . '>' . esc_html($city_label) . '</option>';
                        }
                        ?>
                    </select>
                <?php else: ?>
