<?php
/** MILLDONE
 * Template Name: Valores de cierre
 * src: page-templates\user_valores_cierre.php
    ...
    <div class="col-md-9 dashboard-margin">
        ...
        <div class="col-md-12 wpestate_dash_coluns">
            <div class="wpestate_dashboard_content_wrapper">
              <a href="#"><strong>Valores de cierre</strong></a> | <a href="/rentabilidad-por-zonas/" class="tab-valores-cierre">Rentabilidad por valorización</a>
              <hr>
                <p>Tocá o hacé clic sobre la zona que querés consultar. Usá el buscador para encontrar rápido la zona que estás buscando.</p>
  ...
  "villa-munoz": { lat: -34.8833, lng: -56.1833, zoom: 15 }
                  ...
                  function initMap() {
                    ...
                    const kmlLayer = new google.maps.KmlLayer({
                      url: 'https://ofiliaria.com.uy/assets/mapvalcierre3.kml',
                      map: mapa,
                ...
                <br>
              <?php
            echo do_shortcode ('[elementor-template id="15619"]');
            ?>
            </div>
        </div>
    </div>
