...
if (!function_exists('wpestate_is_user_dashboard')):
    function wpestate_is_user_dashboard() {
        ...
        $dashboard_pages = array(
            ...
            'page-templates/user_valores_cierre.php',
            'page-templates/user_rentabilidad.php',
            ...
            'page-templates/user_dashboard_referidos.php',
            'page-templates/user_dashboard_billetera.php',
            'page-templates/user_dashboard_clm.php',
            'page-templates/user_dashboard_contrato_add.php',
            'page-templates/user-editar-contrato.php',
            'page-templates/user-contratos-details.php',
            'wpestate-crm-dashboard.php',
            'wpestate-crm-dashboard_contacts.php',
            'wpestate-crm-dashboard_leads.php',
            // inicio cambios Ofiliaria
            'ofiliaria-mercadolibre.php',
            'garantias.php',
            'seleccionar-aseguradora.php',
            'datos-propiedad.php',
            'datos-arrendatario.php',
            'personas-adicionales.php',
            'detalle-garantia.php',
            'garantia-enviada.php',
            'revision-garantia.php',
            'contrato-garantia.php',
            'inventario-garantia.php',
            'firma-contrato.php',
            'pago-garantia.php',
            'ofiliaria-infocasas.php'
