        ...
        if( $page_template=='page-templates/splash_page.php' ){
            ...
            if( wpestate_check_google_map_tax()  ){
                ...
                ( $header_type==0
                    ...
                    && $page_template!=='page-templates/user_valores_cierre.php'
                    && $page_template!=='page-templates/user_rentabilidad.php'
                    ...
                    && $page_template!=='page-templates/user_dashboard_referidos.php'
                    && $page_template!=='page-templates/user_dashboard_billetera.php'
                    && $page_template!=='page-templates/user_dashboard_clm.php'
                    && $page_template!=='page-templates/user_dashboard_contrato_add.php'
                    && $page_template!=='page-templates/user-editar-contrato.php'
                    && $page_template!=='page-templates/user-contratos-details.php'
