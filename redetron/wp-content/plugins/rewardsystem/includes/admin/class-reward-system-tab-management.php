...
if ( ! class_exists( 'RSTabManagement' ) ) {
	...
	class RSTabManagement {
		...
		public static function add_submenu_woocommerce() {
			...
			$name = ( '' == get_option( 'rs_brand_name' ) ) ? __( 'Saldo Virtual Ofiliaria', 'rewardsystem' ) : get_option( 'rs_brand_name' );
					...
					<h2 class="nav-tab-wrapper woo-nav-tab-wrapper rs_tab_design">
						...
						<div class="fp-srp-page-header" >
							<div class="fp-srp-page-title" >
								<h1> <strong><?php esc_html_e( 'Saldo Virtual Ofiliaria', 'rewardsystem' ); ?></strong></h1>
							</div>
							<div class="fp-srp-branding-logo" >
								<a href="https://redetronic.com/" target="_blank" ><img src="<?php echo esc_url( SRP_PLUGIN_DIR_URL ); ?>/assets/images/logolofiliaria-saldo-virtual.png" /></a>
							</div>
						</div>
						<?php endif; ?>
						<ul>
