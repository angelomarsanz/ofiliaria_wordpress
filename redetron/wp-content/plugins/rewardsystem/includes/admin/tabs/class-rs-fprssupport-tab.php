...
if ( ! class_exists( 'RSSupportTab' ) ) {
	...
	class RSSupportTab {
		...
		public static function fp_support_content() {
			?>
			<h3><?php esc_html_e( 'Documentación', 'rewardsystem' ); ?></h3>
			<p><?php esc_html_e( 'Para conocer manuales y tutoriales, por favor consulte el e-mail recibido por Redetronic para visualizar los manuales enviados, en caso de no ubicarlos, contacte con el equipo de redetronic.', 'rewardsystem' ); ?></p>
			<h3><?php esc_html_e( 'Contactar a Soporte', 'rewardsystem' ); ?></h3>
			<p id="fp_support_content"><?php esc_html_e( ' Para contactar con nuestro soporte, por favor envie un ticket desde ', 'rewardsystem' ); ?><a href="https://app.redetronic.com/" target="_blank"><?php esc_html_e( 'su cuenta de cliente', 'rewardsystem' ); ?></a></p>
			<?php
		}
	}
